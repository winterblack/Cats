...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { birth_date: @cat.birth_date, color: @cat.color, description: @cat.description, name: @cat.name, sex: @cat.sex }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { birth_date: @cat.birth_date, color: @cat.color, description: @cat.description, name: @cat.name, sex: @cat.sex }
    assert_redirected_to cat_path(assigns(:cat))
  end
